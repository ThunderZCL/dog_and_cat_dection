...
path = '/home/thunder/桌面/tensorflow-vgg16-train-and-test-master/picture/'
w = 224
h = 224
c = 3
...
def build_network(height, width, channel):
    ...
    y = tf.placeholder(tf.int64, shape=[None, len(cate)], name='labels_placeholder')
    ...
    cost = tf.reduce_mean(tf.nn.softmax_cross_entropy_with_logits_v2(logits=finaloutput, labels=y))
